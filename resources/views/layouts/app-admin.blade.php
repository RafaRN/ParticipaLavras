                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('participaLavras') }}">Sobre o ParticipaLavras!</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('informacoes') }}">Informações</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('usuarios') }}">Usuários</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('denuncias') }}">Denúncias</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('email.editar') }}">
                                        Redefinir E-mail
                                    </a>
